...
(define-fun phi ((rff Real) (rfb Real) (rbf Real) (rbb Real) (sff Real) (sfb Real) (sbf Real) (sbb Real) (r Real) (s Real)) Bool
  (and
...
(push)
  ...
  (assert (phi rff rfb rbf rbb sff sfb sbf sbb r s))
  (check-sat)
  ...
  (define-fun psi () Bool
    (forall ((rff Real) (rfb Real) (rbf Real) (rbb Real) (sff Real) (sfb Real) (sbf Real) (sbb Real))
      (exists ((r Real) (s Real))
        (phi rff rfb rbf rbb sff sfb sbf sbb r s)
      )
    )
  )
  (assert (not psi))
